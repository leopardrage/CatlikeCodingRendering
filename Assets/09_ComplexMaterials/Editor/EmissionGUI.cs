...
public class EmissionGUI : ShaderGUI {
    ...
    // Min brightness, Max brightness, Min exposure, Max exposure.
    // the given values match the Standard Shader
    ...
    void DoEmission() {
        ...
        editor.TexturePropertyWithHDRColor(
            ...
            // emissionConfig, // Obsolete
            false // alpha channel is not used so we want it hidden
        );
        if (EditorGUI.EndChangeCheck()) {
