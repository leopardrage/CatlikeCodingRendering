...
public class StaticLightingGUI : ShaderGUI {
    ...
    void DoEmission() {
        ...
        if (EditorGUI.EndChangeCheck()) {
            ...
            // To baked emissive values Unity sometimes need to notified by
            // settings the corrensponding globalIlluminationFlags.
            // For semplicity, we just set that flag for all selected materials
            // if we edit the emissive somehow.
