#if !defined(GPU_INSTANCING_META)
#define GPU_INSTANCING_META
...
Interpolators MyLightmappingVertexProgram(VertexData v) {
    ...
    // The UnityMetaVertexPosition function does the conversion written
    // above but uses the correct uvs (and related offset and scaling data)
    // depending on whether we are in baked or realtime GI mode.
