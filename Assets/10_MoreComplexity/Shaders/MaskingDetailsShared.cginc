#if !defined(MASKING_DETAILS_SHARED)
#define MASKING_DETAILS_SHARED
...
float GetDetailMask(Interpolators i) {
        ...
        // Detail mask values are assumed to be stored in all 4 channels.
        // We just use the A channel by convention.
