...
#if !defined(WIREFRAME_SHARED)
#define WIREFRAME_SHARED

#include "WireframeInputIncludedShared.cginc"

// To allow code that include this file to replace the GetAlbedo function with
// a custom one, we access it via a macro. If the including code define a custom
// albedo function via that macro, that function will be used. Otherwise, the
// default one, provided in WireframeInputIncludedShared.cginc, will be used
