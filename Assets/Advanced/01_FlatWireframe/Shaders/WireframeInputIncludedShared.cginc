...
#if !defined(WIREFRAME_INPUT_INCLUDED_SHARED)
#define WIREFRAME_INPUT_INCLUDED_SHARED
...
struct Interpolators {
    ...
    // For shaders that uses a geometry program and include this files
    // for regular vertex and fragment program: this macro allows them to
    // add properties to the Interpolators struct transparently to this file.
